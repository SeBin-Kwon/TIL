...
for i in movies:
    print(i.director,i.genre,i.title,i.opening_data,i.running_time,i.screening)
```
...
movies = Movie.objects.all()
for i in movies:
    print(i.director.name,i.genre,i.title,i.opening_data,i.running_time,i.screening)
```
...
movies = Movie.objects.all()
for i in movies:
    print(i.director.name,i.genre.title,i.title,i.opening_data,i.running_time,i.screening)
```
...
```python
movies = Movie.objects.all().order_by('-opening_data')
for i in movies:
    print(i.director.name,i.genre.title,i.title,i.opening_data,i.running_time,i.screening)
```
...
```python
movies = Movie.objects.all().order_by('opening_data')[:1]
for i in movies:
    print(i.director.name,i.genre.title,i.title,i.opening_data,i.running_time,i.screening)
```
...
```python
movies = Movie.objects.filter(screening=1).order_by('opening_data')
for i in movies:
    print(i.director.name,i.genre.title,i.title,i.opening_data,i.running_time,i.screening)
```
...
```python
d_name = Director.objects.get(name='봉준호')
movies = Movie.objects.filter(director=d_name).order_by('opening_data')
for i in movies:
    print(i.director.name,i.genre.title,i.title,i.opening_data,i.running_time,i.screening)
```
...
```python
d_name = Director.objects.get(name='봉준호')
movies = Movie.objects.filter(director=d_name).order_by('opening_data')[1:2]
for i in movies:
    print(i.director.name,i.genre.title,i.title,i.opening_data,i.running_time,i.screening)
```
...
```python
movies = Movie.objects.filter(opening_data__gt='2022-01-01').order_by('opening_data')
for i in movies:
    print(i.director.name,i.genre.title,i.title,i.opening_data,i.running_time,i.screening)
```
...
```python
d_name = Director.objects.get(name='봉준호')
d_genre = Genre.objects.get(title='드라마')
movies = Movie.objects.filter(director=d_name,genre=d_genre).order_by('opening_data')
for i in movies:
    print(i.director.name,i.genre.title,i.title,i.opening_data,i.running_time,i.screening)
```
...
```python
d_name = Director.objects.get(name='봉준호')
movies = Movie.objects.exclude(director=d_name).order_by('opening_data')
for i in movies:
    print(i.director.name,i.genre.title,i.title,i.opening_data,i.running_time,i.screening)
```