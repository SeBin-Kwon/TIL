...
| ![스크린샷 2024-11-05 오전 1.26.02](assets/스크린샷 2024-11-05 오전 1.26.02.png) | ![스크린샷 2024-11-05 오전 1.25.38](assets/스크린샷 2024-11-05 오전 1.25.38.png) |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
- 스토리보드에서 화면을 보면 3가지 점 중 맨 왼쪽 노란색 버튼이 있다.
- 그것을 **컨트롤을 누른채** 이동하려는 화면으로 드래그하면
- 어떤 화면으로 띄울지 선택창이 뜬다. 이 중 `Present Modally`를 선택한다.

| ![스크린샷 2024-11-05 오전 1.27.55](assets/스크린샷 2024-11-05 오전 1.27.55.png) | ![스크린샷 2024-11-05 오전 1.30.24](assets/스크린샷 2024-11-05 오전 1.30.24.png) |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
